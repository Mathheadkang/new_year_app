...
Page({
    ...
    // 绘制背景图片
    drawBackgroundImages(canvas, ctx, _canvasWidth, _canvasHeight) {
    ...
    // 绘制小程序码
    drawQRCode(canvas, ctx, qrCodePath, canvasWidth, canvasHeight) {
        return new Promise((resolve) => {
    ...
    // 导出 Canvas 图片
    exportCanvasImage(canvas, resolve, reject) {
        setTimeout(() => {
